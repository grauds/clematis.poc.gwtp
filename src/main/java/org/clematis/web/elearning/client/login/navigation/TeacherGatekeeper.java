...
@Singleton
public class TeacherGatekeeper implements Gatekeeper {

	protected boolean isLoggedIn() {
		return ELP.getConnectionState().isLoggedIn && ELP.getConnectionState().isTeacher();
	}
	...
	@Inject
	public TeacherGatekeeper(PlaceManager placeManager) {
