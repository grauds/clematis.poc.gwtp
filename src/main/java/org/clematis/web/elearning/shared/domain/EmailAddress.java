...
public class EmailAddress implements Serializable
{
	 ...
	 * 
	 */
	private static final long serialVersionUID = 7320150646318696380L;
...
//domain text - non white space controls and the rest of ASCII chars not including [, ], or \:
    public static final String dtext = "[" + noWsCtl + "\\x21-\\x5A\\x5E-\\x7E]";
    public static final String dcontent = dtext + "|" + quotedPair;
    public static final String domainLiteral = "\\[" + "(" + fwsp + dcontent + "+)*" + fwsp + "\\]";
    public static final String rfc2822Domain = "(" + dotAtom + "|" + domainLiteral + ")";

    public static final String domain = ALLOW_DOMAIN_LITERALS ? rfc2822Domain : rfc1035DomainName;

    public static final String localPart = "((" + dotAtom + ")|(" + quotedString + "))";
    public static final String addrSpec = localPart + "@" + domain;
    public static final String angleAddr = "<" + addrSpec + ">";
    public static final String nameAddr = "(" + phrase + ")?" + fwsp + angleAddr;
    //class attributes
    private String text;
